...
export default function RaahiApp(){
 ...
 return <main className="app-shell">
  ...
  <nav className="tabs">{(["journey","party","report","evidence"] as const).map(v=><button key={v} className={view===v?"active":""} onClick={()=>setView(v)}>{v==="journey"?"My journey":v==="party"?"Trail party":v==="report"?"Report a change":"Trust receipt"}</button>)}</nav>
